...
;;  PortB, bit 0 has channel 9 mapped to it
  #DEFINE PIN21_CH 16
  #DEFINE PIN21_SINK YES
  #DEFINE PIN21_PWM YES

;;  PortB, bit 1 has channel 10 mapped to it
  #DEFINE PIN22_CH 15
  #DEFINE PIN22_SINK YES
  #DEFINE PIN22_PWM YES

;;  PortB, bit 2 has channel 11 mapped to it
  #DEFINE PIN23_CH 14
  #DEFINE PIN23_SINK YES
  #DEFINE PIN23_PWM YES

;;  PortB, bit 3 has channel 12 mapped to it
  #DEFINE PIN24_CH 13
  #DEFINE PIN24_SINK YES
  #DEFINE PIN24_PWM YES

;;  PortB, bit 4 has channel 13 mapped to it
  #DEFINE PIN25_CH 12
  #DEFINE PIN25_SINK YES
  #DEFINE PIN25_PWM YES

;;  PortB, bit 5 has channel 14 mapped to it
  #DEFINE PIN26_CH 11
  #DEFINE PIN26_SINK YES
  #DEFINE PIN26_PWM YES

;;  PortB, bit 6 has channel 15 mapped to it
  #DEFINE PIN27_CH 10
  #DEFINE PIN27_SINK YES
  #DEFINE PIN27_PWM YES

;;  PortB, bit 7 has channel 16 mapped to it
  #DEFINE PIN28_CH 9
