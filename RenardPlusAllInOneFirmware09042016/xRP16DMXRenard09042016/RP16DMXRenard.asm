...
;;  PIN 17 (RC6/TX) - uart_out (output)
;;  PIN 18 (RC7/RX) - uart_in (input)
;;  PIN 21 (RB0) - triac driver 13 (output)
;;  PIN 22 (RB1) - triac driver 14 (output)
;;  PIN 23 (RB2) - triac driver 15 (output)
;;  PIN 24 (RB3) - triac driver 16 (output)
;;  PIN 25 (RB4) - triac driver 9  (output)
;;  PIN 26 (RB5) - triac driver 10 (output)
;;  PIN 27 (RB6) - triac driver 11 (output)
;;  PIN 28 (RB7) - triac driver 12 (output)
...
rx_not_sync:
	...
	goto	mainloop
	btfsc	FSR0L,4		; skip if non-echo state,,RP32 5 changed TR16 4 for TR8 3
