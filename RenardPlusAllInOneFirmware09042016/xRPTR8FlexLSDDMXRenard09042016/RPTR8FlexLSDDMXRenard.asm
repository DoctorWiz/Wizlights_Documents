...
;;  and modified to accommodate a 32 channel controller by Mac Macmillan (Phoenix)
;;
...
;;  PIN 17 (RC6/TX) - uart_out (output)
;;  PIN 18 (RC7/RX) - uart_in (input)
;;  PIN 21 (RB0) - triac driver 13 Red (output)
;;  PIN 22 (RB1) - triac driver 14 Green (output)
;;  PIN 23 (RB2) - triac driver 15 Blue (output)
;;  PIN 24 (RB3) - triac driver 16 White (output)
;;  PIN 25 (RB4) - triac driver 9  Red (output)
;;  PIN 26 (RB5) - triac driver 10 Green (output)
;;  PIN 27 (RB6) - triac driver 11 Blue (output)
;;  PIN 28 (RB7) - triac driver 12 White (output)
;;
;;  NOTE:
;;
;;  This firmware is configured for PWM use with 38400 baud communications.
...
;;  PortB, bit 0 has channel 13 Red mapped to it
  #DEFINE PIN21_CH 13
  #DEFINE PIN21_SINK NO
  #DEFINE PIN21_PWM YES

;;  PortB, bit 1 has channel 14 Green mapped to it
  #DEFINE PIN22_CH 14
  #DEFINE PIN22_SINK NO
  #DEFINE PIN22_PWM YES

;;  PortB, bit 2 has channel 15 Blue mapped to it
  #DEFINE PIN23_CH 15
  #DEFINE PIN23_SINK NO
  #DEFINE PIN23_PWM YES

;;  PortB, bit 3 has channel 16 White mapped to it
  #DEFINE PIN24_CH 16
  #DEFINE PIN24_SINK NO
  #DEFINE PIN24_PWM YES

;;  PortB, bit 4 has channel 9 Red mapped to it
  #DEFINE PIN25_CH 9
  #DEFINE PIN25_SINK NO
  #DEFINE PIN25_PWM YES

;;  PortB, bit 5 has channel 10 Green mapped to it
  #DEFINE PIN26_CH 10
  #DEFINE PIN26_SINK NO
  #DEFINE PIN26_PWM YES

;;  PortB, bit 6 has channel 11 Blue mapped to it
  #DEFINE PIN27_CH 11
  #DEFINE PIN27_SINK NO
  #DEFINE PIN27_PWM YES

;;  PortB, bit 7 has channel 12 White mapped to it
  #DEFINE PIN28_CH 12
