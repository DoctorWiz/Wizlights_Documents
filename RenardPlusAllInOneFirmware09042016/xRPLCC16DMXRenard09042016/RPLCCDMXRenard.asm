...
;;  PIN 7  (RA5) - VCAP for PIC16F7xx
;;  PIN 10 (RA6) - spare - future option
;;  PIN 9  (RA7) - spare - future option
;;  PIN 11 (RC0) - spare - future option 
;;  PIN 12 (RC1) - triac driver 6 (output)
;;  PIN 13 (RC2) - triac driver 7 (output)
;;  PIN 14 (RC3) - triac driver 8 (output)
;;  PIN 15 (RC4) - triac driver 16 (output)
;;  PIN 16 (RC5) - LED driver (Status)
;;  PIN 17 (RC6/TX) - uart_out (output)
;;  PIN 18 (RC7/RX) - uart_in (input)
;;  PIN 21 (RB0) - triac driver 15 (output)
;;  PIN 22 (RB1) - spare - future option
...
;;  PortB, bit 0 has channel 15 mapped to it
  #DEFINE PIN21_CH 15
  #DEFINE PIN21_SINK YES
  #DEFINE PIN21_PWM YES

;;  PortB, bit 1 spare future option
...
;;  PortC, bit 0 future option
  #DEFINE PIN11_SINK NO
  #DEFINE PIN11_PWM YES

;;  PortC, bit 1 has channel 6 mapped to it
  #DEFINE PIN12_CH 6
  #DEFINE PIN12_SINK YES
  #DEFINE PIN12_PWM YES

;;  PortC, bit 2 has channel 7 mapped to it
  #DEFINE PIN13_CH 7
  #DEFINE PIN13_SINK YES
  #DEFINE PIN13_PWM YES

;;  PortC, bit 3 has channel 8 mapped to it
  #DEFINE PIN14_CH 8
...
;;  PortC, bit 4 has channel 16 mapped to it
  #DEFINE PIN15_CH 16
