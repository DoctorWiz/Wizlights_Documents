...
;;  PIN 16 (RC1) - triac driver not used
;;  PIN 17 (RC2) - triac driver not used
;;  PIN 18 (RC3) - triac driver not used
;;  Pin 19 (RD0) - triac driver not used
;;  Pin 20 (RD1) - Status LED ZC and HeartBeat, tri pulse beat
;;  PIN 21 (RD2) - triac driver not used
;;  PIN 22 (RD3) - triac driver not used
;;  PIN 23 (RC4) - triac driver not used
;;  PIN 24 (RC5) - triac driver not used
;;  PIN 25 (RC6/TX) - uart_out (output)
;;  PIN 26 (RC7/RX) - uart_in (input)
;;  PIN 27 (RD4) - triac driver 24 (output)
;;  PIN 28 (RD5) - triac driver 23 (output)
;;  PIN 29 (RD6) - triac driver 22 (output)
;;  PIN 30 (RD7) - triac driver 21 (output)
;;  PIN 31 (VSS)
;;  PIN 32 (VDD)
;;  PIN 33 (RB0) - triac driver 20 (output)
;;  PIN 34 (RB1) - triac driver 19 (output)
;;  PIN 35 (RB2) - triac driver 18 (output)
;;  PIN 36 (RB3) - triac driver 17 (output)
;;  PIN 37 (RB4) - triac driver 16 (output)
;;  PIN 38 (RB5) - triac driver 15 (output)
;;  PIN 39 (RB6) - triac driver 14 (output)
;;  PIN 40 (RB7) - triac driver 13 (output)
...
#ELSE
;;  ******* PIC18F4xK22 Selections ******
;; Define Baud Rates. uncomment one of the following Baud Rates
 #DEFINE BAUDRATE 57600
;; #DEFINE BAUDRATE 115200
;; #DEFINE BAUDRATE 230400  
;; #DEFINE BAUDRATE 460800  ;;use with PIC18F4xK22 Only
...
#ELSE
 ...
 #DEFINE CLOCKRATE 32000000  ;;PIC18F4520 or PIC18F45K22
...
#define DMX_BLINK_RATE (44)  ;;Do not Remove or change
...
;;**************************************************************************
;;************************ INCANDESCENT LIGHT DEFINITIONS ******************
;;**************************************************************************
...
;;  PortB, bit 1 has channel 19 mapped to it
  #DEFINE PIN34_CH 19
  #DEFINE PIN34_SINK YES
  #DEFINE PIN34_PWM YES

;;  PortB, bit 2 has channel 18 mapped to it
  #DEFINE PIN35_CH 18
...
;;  PortB, bit 4 has channel 16 mapped to it
  #DEFINE PIN37_CH 16
  #DEFINE PIN37_SINK YES
  #DEFINE PIN37_PWM YES

;;  PortB, bit 5 has channel 15 mapped to it
  #DEFINE PIN38_CH 15
...
;;  PortB, bit 7 has channel 13 mapped to it
  #DEFINE PIN40_CH 13
...
;;  PortD, bit 4 has channel 24 mapped to it
  #DEFINE PIN27_CH 24
...
;;  PortD, bit 6 has channel 22 mapped to it
  #DEFINE PIN29_CH 22
  #DEFINE PIN29_SINK YES
  #DEFINE PIN29_PWM YES

;;  PortD, bit 7 has channel 21 mapped to it
  #DEFINE PIN30_CH 21
...
;; registers 0x70 (112) through 0x76  (118)
